...
Text GLabel 10300 5100 0    50   UnSpc ~ 0
COM
...
U 1 1 5FDDD488
P 10600 4800
F 0 "J14" H 10650 5550 50  0000 C CNN
F 1 "Conn_02x13_Top_Bottom" H 10650 5526 50  0001 C CNN
F 2 "Connector_IDC:IDC-Header_2x13_P2.54mm_Latch_Vertical" H 10600 4800 50  0001 C CNN
F 3 "https://www.chipdip.ru/product/idc-26ms" H 10600 4800 50  0001 C CNN
	1    10600 4800
	1    0    0    -1  
$EndComp
...
DRIVE_PZ-
Text GLabel 11000 4500 2    50   Output ~ 0
DRIVE_PB-
Text GLabel 11000 4600 2    50   Output ~ 0
DRIVE_PB+
Text GLabel 11000 4700 2    50   Output ~ 0
DRIVE_PA-
Text GLabel 11000 4800 2    50   Output ~ 0
DRIVE_PA+
Wire Wire Line
...
Text GLabel 11000 5300 2    50   Output ~ 0
DRIVE_VREF
Wire Wire Line
...
U 1 1 606517C2
P 12350 3950
F 0 "J15" H 12200 5450 50  0000 L CNN
F 1 "DB25_Female" H 12000 5350 50  0000 L CNN
F 2 "Connector_Dsub:DSUB-25_Female_Horizontal_P2.77x2.84mm_EdgePinOffset7.70mm_Housed_MountingHolesOffset9.12mm" H 12350 3950 50  0001 C CNN
F 3 "https://www.chipdip.ru/product/drb-25fa" H 12350 3950 50  0001 C CNN
	1    12350 3950
	1    0    0    -1  
$EndComp
Text GLabel 11950 2750 0    50   UnSpc ~ 0
COM
Text GLabel 11950 2850 0    50   Input ~ 0
SM1
Text GLabel 11950 2950 0    50   UnSpc ~ 0
PWR
Text GLabel 11950 3050 0    50   Output ~ 0
DRIVE_PZ+
Text GLabel 11950 3250 0    50   Output ~ 0
DRIVE_PZ-
Text GLabel 11950 3450 0    50   Output ~ 0
DRIVE_PB-
Text GLabel 11950 3550 0    50   Input ~ 0
DM1
Text GLabel 11950 3650 0    50   Output ~ 0
DRIVE_PB+
Text GLabel 11950 3850 0    50   Output ~ 0
DRIVE_PA-
Text GLabel 11950 3950 0    50   Input ~ 0
DRIVE_SigIn2
Text GLabel 11950 4050 0    50   Output ~ 0
DRIVE_PA+
Text GLabel 11950 4150 0    50   Input ~ 0
SigIn4
Text GLabel 11950 4250 0    50   Input ~ 0
SigIn3
Text GLabel 11950 4350 0    50   Input ~ 0
PWR
Text GLabel 11950 4550 0    50   UnSpc ~ 0
COM
...
SigOut3
Text GLabel 11950 5050 0    50   Output ~ 0
DRIVE_VREF
Wire Wire Line
...
GND
$Comp
L Power_Protection:USBLC6-4SC6 U18
U 1 1 60ED8C2C
P 10200 7350
F 0 "U18" H 10350 7000 50  0000 C CNN
F 1 "IP4220CZ6" H 10400 6900 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 10200 6850 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 10400 7700 50  0001 C CNN
	1    10200 7350
	1    0    0    -1  
$EndComp
Text GLabel 10850 6850 2    50   UnSpc ~ 0
3V
Text GLabel 10100 7750 0    50   UnSpc ~ 0
GND
Wire Wire Line
...
Wire Wire Line
	10200 6850 10700 6850
Wire Wire Line
	10700 6850 10850 6850
Connection ~ 10700 6850
Wire Wire Line
	10850 7150 10700 7150
...
U 1 1 60007BCD
P 9450 3550
F 0 "R23" V 9450 3550 50  0000 C CNN
...
U 1 1 60B32DF0
P 11600 5900
F 0 "U21" H 11600 6225 50  0000 C CNN
F 1 "PC817" H 11600 6134 50  0000 C CNN
F 2 "Package_DIP:SMDIP-4_W7.62mm" H 11400 5700 50  0001 L CIN
F 3 "http://www.soselectronic.cz/a_info/resource/d/pc817.pdf" H 11600 5900 50  0001 L CNN
	1    11600 5900
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 60B32DFA
P 11000 5800
F 0 "R27" V 10793 5800 50  0000 C CNN
F 1 "220" V 10884 5800 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 10930 5800 50  0001 C CNN
...
Text GLabel 11150 6000 0    50   UnSpc ~ 0
DRIVE_ENABLE
Wire Wire Line
	11150 6000 11250 6000
Text GLabel 11950 6000 2    50   UnSpc ~ 0
COM
Wire Wire Line
...
Text GLabel 10700 5800 0    50   UnSpc ~ 0
3V
...
U 1 1 60BF4B4E
P 11450 6150
F 0 "*J1" H 11450 5950 50  0000 C CNN
F 1 "Screw_Terminal_01x02" H 11368 5916 50  0001 C CNN
F 2 "TerminalBlock_Phoenix:TerminalBlock_Phoenix_MKDS-1,5-2_1x02_P5.00mm_Horizontal" H 11450 6150 50  0001 C CNN
F 3 "https://www.chipdip.ru/product/idcc-26ms" H 11450 6150 50  0001 C CNN
	1    11450 6150
	1    0    0    -1  
$EndComp
Wire Wire Line
...
Wire Wire Line
	11250 6000 11300 6000
Text GLabel 11200 6250 0    50   UnSpc ~ 0
GND
Wire Wire Line
...
Wire Bus Line
	2000 9500 1000 9500
Text GLabel 8000 7250 0    50   UnSpc ~ 0
SPI1_SO_PROT
Text GLabel 8000 7450 0    50   UnSpc ~ 0
SPI1_SCK_PROT
Text GLabel 8800 7450 2    50   UnSpc ~ 0
SPI1_CS_PROT
Text GLabel 9800 7450 0    50   UnSpc ~ 0
SHIFTER_Y
Text GLabel 8800 7250 2    50   UnSpc ~ 0
SHIFTER_X
Text GLabel 9800 7250 0    50   UnSpc ~ 0
PEDAL_CLUCH
Text GLabel 10600 7450 2    50   UnSpc ~ 0
PEDAL_BREAK
Text GLabel 10600 7250 2    50   UnSpc ~ 0
PEDAL_GAS
$Comp
L Power_Protection:USBLC6-4SC6 U11
U 1 1 61B745C4
P 8400 7350
F 0 "U11" H 8550 7000 50  0000 C CNN
F 1 "IP4220CZ6" H 8600 6900 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 8400 6850 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 8600 7700 50  0001 C CNN
	1    8400 7350
	1    0    0    -1  
$EndComp
Text GLabel 9050 6850 2    50   UnSpc ~ 0
3V
Text GLabel 8300 7750 0    50   UnSpc ~ 0
GND
Wire Wire Line
	8300 7750 8400 7750
...
F 3 "https://www.chipdip.ru/product/drb-9fa" H 15150 3600 50  0001 C CNN
	1    15150 3600
	1    0    0    -1  
$EndComp
...
U 1 1 6013964F
P 9600 5050
F 0 "R24" H 9670 5096 50  0000 L CNN
F 1 "560" H 9670 5005 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 9530 5050 50  0001 C CNN
F 3 "https://www.chipdip.ru/product0/9000079474" H 9600 5050 50  0001 C CNN
	1    9600 5050
	1    0    0    -1  
$EndComp
Text GLabel 9600 5600 0    50   UnSpc ~ 0
COM
$Comp
L Device:R R25
U 1 1 601A6AD4
P 9600 5350
F 0 "R25" H 9670 5396 50  0000 L CNN
F 1 "560" H 9670 5305 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric" V 9530 5350 50  0001 C CNN
F 3 "https://www.chipdip.ru/product0/9000079474" H 9600 5350 50  0001 C CNN
	1    9600 5350
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 6057E655
P 13500 9050
F 0 "LOGO1" H 13500 9550 50  0001 C CNN
F 1 "Logo_Open_Hardware_Large" H 13500 8650 50  0001 C CNN
F 2 "Symbol:OSHW-Logo2_14.6x12mm_SilkScreen" H 13500 9050 50  0001 C CNN
...
$EndComp
Wire Wire Line
	14650 2650 14650 1950
Connection ~ 14650 1950
Wire Wire Line
	14650 1950 14850 1950
Text GLabel 14350 2650 0    50   UnSpc ~ 0
SHIFTER_REAR
Text GLabel 5550 9250 0    50   UnSpc ~ 0
SHIFTER_REAR
Wire Wire Line
	2200 9000 2350 9000
Wire Wire Line
...
Text GLabel 8000 8300 0    50   UnSpc ~ 0
B4
Text GLabel 8000 8500 0    50   UnSpc ~ 0
B3
Text GLabel 8800 8500 2    50   UnSpc ~ 0
B2
Text GLabel 8800 8300 2    50   UnSpc ~ 0
B1
$Comp
L Power_Protection:USBLC6-4SC6 U12
U 1 1 60173F3D
P 8400 8400
F 0 "U12" H 8550 8050 50  0000 C CNN
F 1 "IP4220CZ6" H 8600 7950 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 8400 7900 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 8600 8750 50  0001 C CNN
	1    8400 8400
	1    0    0    -1  
$EndComp
Text GLabel 9050 7900 2    50   UnSpc ~ 0
3V
Text GLabel 8300 8800 0    50   UnSpc ~ 0
GND
Wire Wire Line
	8300 8800 8400 8800
...
Wire Wire Line
	9050 8200 8900 8200
Text GLabel 9450 8300 0    50   UnSpc ~ 0
B8
Text GLabel 9450 8500 0    50   UnSpc ~ 0
B7
Text GLabel 10250 8500 2    50   UnSpc ~ 0
B6
Text GLabel 10250 8300 2    50   UnSpc ~ 0
B5
$Comp
L Power_Protection:USBLC6-4SC6 U17
U 1 1 60278844
P 9850 8400
F 0 "U17" H 10000 8050 50  0000 C CNN
F 1 "IP4220CZ6" H 10050 7950 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 9850 7900 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 10050 8750 50  0001 C CNN
	1    9850 8400
	1    0    0    -1  
$EndComp
Text GLabel 10500 7900 2    50   UnSpc ~ 0
3V
Text GLabel 9750 8800 0    50   UnSpc ~ 0
GND
Wire Wire Line
	9750 8800 9850 8800
Wire Wire Line
	9850 8000 9850 7900
Wire Wire Line
	9850 7900 10500 7900
Text GLabel 8000 9350 0    50   UnSpc ~ 0
B16
Text GLabel 8000 9550 0    50   UnSpc ~ 0
B15
Text GLabel 8800 9550 2    50   UnSpc ~ 0
B14
Text GLabel 8800 9350 2    50   UnSpc ~ 0
B13
$Comp
L Power_Protection:USBLC6-4SC6 U13
U 1 1 60404DF2
P 8400 9450
F 0 "U13" H 8550 9100 50  0000 C CNN
F 1 "IP4220CZ6" H 8600 9000 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 8400 8950 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 8600 9800 50  0001 C CNN
	1    8400 9450
	1    0    0    -1  
$EndComp
Text GLabel 9050 8950 2    50   UnSpc ~ 0
3V
Text GLabel 8300 9850 0    50   UnSpc ~ 0
GND
Wire Wire Line
	8300 9850 8400 9850
...
Wire Wire Line
	9050 9250 8900 9250
Text Notes 10550 11000 0    50   ~ 0
SUPPRESSORS
Text GLabel 9400 9350 0    50   UnSpc ~ 0
B12
Text GLabel 9400 9550 0    50   UnSpc ~ 0
B11
Text GLabel 10200 9550 2    50   UnSpc ~ 0
B10
Text GLabel 10200 9350 2    50   UnSpc ~ 0
B9
$Comp
L Power_Protection:USBLC6-4SC6 U15
U 1 1 60506551
P 9800 9450
F 0 "U15" H 9950 9100 50  0000 C CNN
F 1 "IP4220CZ6" H 10000 9000 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 9800 8950 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 10000 9800 50  0001 C CNN
	1    9800 9450
	1    0    0    -1  
$EndComp
Text GLabel 10450 8950 2    50   UnSpc ~ 0
3V
Text GLabel 9700 9850 0    50   UnSpc ~ 0
GND
Wire Wire Line
	9700 9850 9800 9850
Wire Wire Line
...
Wire Wire Line
	11650 5150 12050 5150
Wire Notes Line
	12700 6600 12700 2300
Wire Notes Line
	6650 6600 12700 6600
Text GLabel 8000 10400 0    50   UnSpc ~ 0
B32
Text GLabel 8000 10600 0    50   UnSpc ~ 0
B31
Text GLabel 8800 10600 2    50   UnSpc ~ 0
B30
Text GLabel 8800 10400 2    50   UnSpc ~ 0
B29
$Comp
L Power_Protection:USBLC6-4SC6 U14
U 1 1 60E27D8D
P 8400 10500
F 0 "U14" H 8550 10150 50  0000 C CNN
F 1 "IP4220CZ6" H 8600 10050 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 8400 10000 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 8600 10850 50  0001 C CNN
	1    8400 10500
	1    0    0    -1  
$EndComp
Text GLabel 9050 10000 2    50   UnSpc ~ 0
3V
Text GLabel 8300 10900 0    50   UnSpc ~ 0
GND
Wire Wire Line
...
Wire Wire Line
	8400 10000 8900 10000
Wire Wire Line
	8900 10000 9050 10000
Connection ~ 8900 10000
Wire Wire Line
	9050 10300 8900 10300
Text GLabel 9400 10400 0    50   UnSpc ~ 0
B28
Text GLabel 9400 10600 0    50   UnSpc ~ 0
B27
Text GLabel 10200 10600 2    50   UnSpc ~ 0
B26
Text GLabel 10200 10400 2    50   UnSpc ~ 0
B25
$Comp
L Power_Protection:USBLC6-4SC6 U16
U 1 1 60E27DAE
P 9800 10500
F 0 "U16" H 9950 10150 50  0000 C CNN
F 1 "IP4220CZ6" H 10000 10050 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 9800 10000 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 10000 10850 50  0001 C CNN
	1    9800 10500
	1    0    0    -1  
$EndComp
Text GLabel 10450 10000 2    50   UnSpc ~ 0
3V
Text GLabel 9700 10900 0    50   UnSpc ~ 0
GND
Wire Wire Line
	9700 10900 9800 10900
Wire Wire Line
	9800 10100 9800 10000
Wire Notes Line
	7350 6650 7350 11050
Wire Notes Line
	7350 11050 11200 11050
Wire Wire Line
	9800 10000 10450 10000
Text GLabel 10800 9350 0    50   UnSpc ~ 0
B24
Text GLabel 10800 9550 0    50   UnSpc ~ 0
B23
Text GLabel 11600 9550 2    50   UnSpc ~ 0
B22
$Comp
L Power_Protection:USBLC6-4SC6 U20
U 1 1 611F8F33
P 11200 9450
F 0 "U20" H 11350 9100 50  0000 C CNN
F 1 "IP4220CZ6" H 11400 9000 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 11200 8950 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 11400 9800 50  0001 C CNN
	1    11200 9450
	1    0    0    -1  
$EndComp
Text GLabel 11850 8950 2    50   UnSpc ~ 0
3V
Text GLabel 11100 9850 0    50   UnSpc ~ 0
GND
Wire Wire Line
	11100 9850 11200 9850
Wire Wire Line
	11200 9050 11200 8950
Text GLabel 10800 8300 0    50   UnSpc ~ 0
B17
Text GLabel 10800 8500 0    50   UnSpc ~ 0
B18
Text GLabel 11600 8500 2    50   UnSpc ~ 0
B19
Text GLabel 11600 8300 2    50   UnSpc ~ 0
B20
$Comp
L Power_Protection:USBLC6-4SC6 U19
U 1 1 611F8F54
P 11200 8400
F 0 "U19" H 11350 8050 50  0000 C CNN
F 1 "IP4220CZ6" H 11400 7950 50  0000 C CNN
F 2 "Package_SO:TSOP-6_1.65x3.05mm_P0.95mm" H 11200 7900 50  0001 C CNN
F 3 "https://www.st.com/resource/en/datasheet/usblc6-4.pdf" H 11400 8750 50  0001 C CNN
	1    11200 8400
	1    0    0    -1  
$EndComp
Text GLabel 11850 7900 2    50   UnSpc ~ 0
3V
Text GLabel 11100 8800 0    50   UnSpc ~ 0
GND
Wire Wire Line
...
Wire Notes Line
	11200 11050 11200 9950
Wire Notes Line
	11200 9950 12150 9950
Wire Notes Line
